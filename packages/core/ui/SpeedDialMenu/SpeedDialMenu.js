...
var _default = function _default(_ref) {
  ...
  }, /*#__PURE__*/_react["default"].createElement(SpeedDial, {
    ariaLabel: "SpeedDial example",
    className: classes.speedDial,
    icon: /*#__PURE__*/_react["default"].createElement(SpeedDialIcon, null),
    onClose: handleClose,
    onOpen: handleOpen,
    open: open,
    direction: "up"
  }, actions.map(function (action) {
    return /*#__PURE__*/_react["default"].createElement(SpeedDialAction, {
      key: action.name,
      icon: action.icon,
